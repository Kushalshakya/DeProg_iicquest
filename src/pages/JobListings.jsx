...
function FilterSection({ filters, onFilterChange }) {
  const locations = ['All Locations', 'San Francisco, CA', 'New York, NY', 'Austin, TX', 'Seattle, WA', 'Los Angeles, CA', 'Chicago, IL', 'Remote'];
  const categories = ['All Categories', 'Technology', 'Design', 'Product', 'Marketing', 'Data Science'];
